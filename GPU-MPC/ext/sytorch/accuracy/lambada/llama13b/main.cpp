...
int test_llamaNextWordLogits_ct(int __argc, char**__argv) {
    ...
    llama_model.load(weights_and_dataset_pth + "/lambada/llama13b/weights.dat");
    ...
    for (int i = start; i < end; ++i) {
        std::string fname = std::string(weights_and_dataset_pth + "/lambada/llama13b/dataset/") + std::to_string(i) + ".dat";
